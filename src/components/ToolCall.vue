    ...
    >
      <span class="tool-copy">
        <span class="tool-heading">
          ...
          <UiIcon v-if="expandable" class="tool-disclosure" name="chevron" />
          <span
        ...
        <span v-if="entry.text" class="tool-argument">{{ entry.text }}</span>
      </span>
    </button>

    <div v-if="expanded && expandable" class="tool-details">
      <div v-if="entry.toolArguments" class="tool-detail">
        <span class="tool-detail-label">Arguments</span>
        <pre class="tool-detail-body">{{ entry.toolArguments }}</pre>
      </div>
      <div v-if="entry.toolResult" class="tool-detail">
